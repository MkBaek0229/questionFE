  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      <div className="w-full max-w-[400px] space-y-8 mt-10">
        {/* 전문가 버튼 */}
        <button
          className="flex flex-col items-center justify-center w-full h-[250px] p-6 bg-green-500 text-white font-bold rounded-xl shadow-lg hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300"
        ...
        {/* 기관회원 버튼 */}
        <button
          className="flex flex-col items-center justify-center w-full h-[250px] p-6 bg-blue-600 text-white font-bold rounded-xl shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
